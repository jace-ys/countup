	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthenticated":
			...
			if formatter != nil {
				...
				body = NewIndexUnauthenticatedResponseBody(res)
			}
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthenticated":
			...
			if formatter != nil {
				...
				body = NewAnotherUnauthenticatedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthenticated":
			...
			if formatter != nil {
				...
				body = NewLoginGoogleUnauthenticatedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthenticated":
			...
			if formatter != nil {
				...
				body = NewLoginGoogleCallbackUnauthenticatedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthenticated":
			...
			if formatter != nil {
				...
				body = NewLogoutUnauthenticatedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "unauthenticated":
			...
			if formatter != nil {
				...
				body = NewSessionTokenUnauthenticatedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)

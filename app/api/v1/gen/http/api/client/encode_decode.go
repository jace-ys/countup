...
func DecodeAuthTokenResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusUnauthorized:
			...
			err = ValidateAuthTokenUnauthenticatedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "AuthToken", err)
			}
			return nil, NewAuthTokenUnauthenticated(&body)
		case http.StatusForbidden:
			...
			err = ValidateAuthTokenAccessDeniedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "AuthToken", err)
			}
			return nil, NewAuthTokenAccessDenied(&body)
		default:
...
func DecodeCounterGetResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusUnauthorized:
			...
			err = ValidateCounterGetUnauthenticatedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "CounterGet", err)
			}
			return nil, NewCounterGetUnauthenticated(&body)
		case http.StatusForbidden:
			var (
			...
			err = ValidateCounterGetAccessDeniedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "CounterGet", err)
			}
			return nil, NewCounterGetAccessDenied(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
...
func DecodeCounterIncrementResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusUnauthorized:
			...
			err = ValidateCounterIncrementUnauthenticatedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "CounterIncrement", err)
			}
			return nil, NewCounterIncrementUnauthenticated(&body)
		case http.StatusForbidden:
			var (
			...
			err = ValidateCounterIncrementAccessDeniedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "CounterIncrement", err)
			}
			return nil, NewCounterIncrementAccessDenied(&body)
		default:
			body, _ := io.ReadAll(resp.Body)

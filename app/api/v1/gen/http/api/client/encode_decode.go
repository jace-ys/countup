...
//   - "incomplete_auth_info" (type *goa.ServiceError): http.StatusUnauthorized
	...
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusUnauthorized:
			...
			case "incomplete_auth_info":
				...
				err = ValidateAuthTokenIncompleteAuthInfoResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("api", "AuthToken", err)
				}
				return nil, NewAuthTokenIncompleteAuthInfo(&body)
			case "unauthorized":
				var (
		...
		case http.StatusForbidden:
			...
			err = ValidateAuthTokenForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "AuthToken", err)
			}
			return nil, NewAuthTokenForbidden(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("api", "AuthToken", resp.StatusCode, string(body))
		}
...
func DecodeCounterGetResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusForbidden:
			...
			err = ValidateCounterGetForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "CounterGet", err)
			}
			return nil, NewCounterGetForbidden(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
...
func DecodeCounterIncrementResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusForbidden:
			...
			err = ValidateCounterIncrementForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("api", "CounterIncrement", err)
			}
			return nil, NewCounterIncrementForbidden(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
